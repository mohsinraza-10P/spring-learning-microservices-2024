package com.mohsin.microservices.api_gateway.config;
...
public class ApiGatewayConfiguration {
    ...
    public RouteLocator gatewayRouter(RouteLocatorBuilder builder) {
        // Path: Route name which we would receive in request
        // Uri: Route name which we would redirect the request path
